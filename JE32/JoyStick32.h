...
public:
    JoyStickAPI(int32_t playerNumber);
    XINPUT_STATE GetState();
    XINPUT_BATTERY_INFORMATION BatteryState();
    bool IsConnected();
    void Vibrate(int32_t leftVal = 0, int32_t rightVal = 0);//
    int64_t BatLevel();
};
JoyStickAPI::JoyStickAPI(int32_t playerNumber)
{
...
void JoyStickAPI::Vibrate(int32_t  leftVal, int32_t rightVal)
{
    // Create a Vibraton State
